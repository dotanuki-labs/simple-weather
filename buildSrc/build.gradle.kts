...
gradlePlugin {
    plugins {
        ...
        register("android-platform-module-plugin") {
            ...
            implementationClass = "plugins.AndroidPlatformModulePlugin"
        }

        register("android-feature-module-plugin") {
            id = "modules.feature.android"
            implementationClass = "plugins.AndroidFeatureModulePlugin"
        }

        register("android-application-module-plugin") {
            id = "modules.app.android"
            implementationClass = "plugins.AndroidApplicationModulePlugin"
        }
    }
}
...
dependencies {
    ...
    // Maps
    dependabot("com.google.android.gms:play-services-maps:18.0.2") { "play-services-maps" }
